...
| DisplayName | X      | X      |        | X       |        | Yes                   | Mapping: Complex: [displayName.js](mapping/displayName.js)                                                                                      | Yes       |         |
| Emails      | X      |        | X      |         |        | Yes                   | Mapping: Complex: [emails.js](mapping/emails.js)<br>Custom scripting in code to transform this to the corresponding scim object                 | Yes       |         |
...
| Username    | X      |        | X      |         |        | Yes                   | Mapping: Complex: [username.js](mapping/username.js)<br>[Required] Correlation property                                                         | Yes       |         |
