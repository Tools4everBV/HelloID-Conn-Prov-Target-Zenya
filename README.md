...
| ----------- | ------ | ------ | ------ | ------- | ------ | --------------------- | -------------------------------------------------------------------------------- | --------- | ------------------------------------------------------------------------------------------------------------------------------ |
| Active      | X      | X      |        | X       |        | Yes                   | For create: Fixed: False<br>For enable: Fixed: True<br>For disable: Fixed: False | Yes       |                                                                                                                                |
| Department  | X      |        | X      |         |        | Yes                   | Field: PrimaryContract.Department.DisplayName                                    | No        | Custom scripting in code to transform this to the corresponding scim object                                                    |
| DisplayName | X      |        | X      |         |        | Yes                   | Complex: [displayName.js](mapping/displayName.js)                                | Yes       |                                                                                                                                |
| Emails      | X      |        | X      |         |        | Yes                   | Complex: [emails.js](mapping/emails.js)                                          | Yes       | Custom scripting in code to transform this to the corresponding scim object                                                    |
| ExternalId  | X      |        | X      |         |        | Yes                   | Field: ExternalId                                                                | Yes       |                                                                                                                                |
| Manager     | X      |        | X      |         |        | Yes                   | None                                                                             | No        | Set within script, as the aRef of manager is used. Custom scripting in code to transform this to the corresponding scim object |
| Title       | X      |        | X      |         |        | Yes                   | Field: PrimaryContract.Title.Name                                                | No        |                                                                                                                                |
| Username    | X      |        | X      |         |        | Yes                   | Complex: [username.js](mapping/username.js)                                      | Yes       | Used for correlation                                                                                                           |
